package at.fhv.shoppingtwist.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, at.fhv.shoppingtwist.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, at.fhv.shoppingtwist.repository.UserRepository.USERS_BY_EMAIL_CACHE);
